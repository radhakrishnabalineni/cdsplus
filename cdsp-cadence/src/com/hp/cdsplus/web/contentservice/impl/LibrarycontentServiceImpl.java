...
public class LibrarycontentServiceImpl extends AbstractGenericService {
		...
		*/
		...
		try {
			...
			while(nodesIterator.hasNext()){
				...
				element.addElement("proj:ref").addAttribute("xlink:type", "simple").addAttribute("xlink:href", "librarycontent/"+subscription+"/"+options.getDocid()+"/"+element.attributeValue("src"));
			}
			return document.asXML();
