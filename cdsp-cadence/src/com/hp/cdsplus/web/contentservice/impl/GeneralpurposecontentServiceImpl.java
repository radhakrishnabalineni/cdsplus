...
public class GeneralpurposecontentServiceImpl extends AbstractGenericService {
	
	public Object getDocumentList(Options options) throws WebApplicationException{
		...
		*/
		...
		try {
			...
			while(nodesIterator.hasNext()){
				...
				element.addElement("proj:ref").addAttribute("xlink:type", "simple").addAttribute("xlink:href", "generalpurposecontent/"+subscription+"/"+options.getDocid()+"/"+element.attributeValue("src"));
			}
			return document.asXML();
