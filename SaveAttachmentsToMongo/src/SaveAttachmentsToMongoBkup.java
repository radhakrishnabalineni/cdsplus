...
public class SaveAttachmentsToMongoBkup {
	...
	public static void saveAttachmentForDocid(String DOC_ID){		
		...
		try {
			...
			Document documentL = null, documentN = null;
			...
			if(documentL.selectNodes("/result/proj:ref").size()>0 && documentN.selectNodes("/result/proj:ref").size()<documentL.selectNodes("/result/proj:ref").size()){
				...
				while(iterator.hasNext()){
					String path = iterator.next().getStringValue();
	...
	public static void writeContent(String dbName, String id, String gridFSFileName,
			String mimeType, String filePath, String updateType,
			Integer priority, boolean deleteFile) throws MongoUtilsException {
