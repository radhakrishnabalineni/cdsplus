...
//	}
	...
	*/
	...
	//SMO : User Story 7650 - get company_name
	public String getCompanyInfo(String companyId) throws DfException {
		String dql = "select company_name from dm_dbo.company where oid="+companyId+"";
		return getColValueAsString(dql, "company_name", "getCompanyInfo");
	}

	@SuppressWarnings("unchecked")
	public Map<String, String> getCompanyInformations(String companyId)
			throws DfException {

		String dql = "select company_name, copyright from dm_dbo.company where oid="
				+ companyId + "";
		Map<String, String> companyInformationMap = getAsMap(dql,
				"company_name", "copyright", "getCompanyInformations");
