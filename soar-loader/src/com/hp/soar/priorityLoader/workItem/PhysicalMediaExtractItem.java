...
public class PhysicalMediaExtractItem extends SoarExtractItem {
	...
	public PhysicalMediaExtractItem(SoarExtractionDBService dbService,
			String eventId, String objectId, boolean isICM, String icmRule, String chronicleId,
			String collectionId, String itemId, String itemState,
			boolean isSuspended, boolean collectionAccepted, Date lastExtractionTime, ProductNames prodNamesMap) throws DfException, ProcessingException, IOException {
