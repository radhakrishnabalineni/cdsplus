...
/**
 * ProductNames is a singleton 
 * @author dahlm
 *
 */
public class ProductNames {

	private static final HashMap<String, HashMap<String, ArrayList<ProductNameBean>>> cache =
		new HashMap<String, HashMap<String, ArrayList<ProductNameBean>>>();
	
  @SuppressWarnings("unchecked")
	static private ArrayList<ProductNameBean> loadProductNames(IDfSession session, String productGroupOid) throws DfException{
   ...
   * @throws DfException 
   */
  public static ArrayList<ProductNameBean> getNameBeans(IDfSession session, String collectionId, 
  		String productGroupOid) throws DfException {
  	
  	HashMap<String, ArrayList<ProductNameBean>> productMap = cache.get(collectionId);
  	if (productMap == null) {
  		// collection isn't started
  		productMap = new HashMap<String, ArrayList<ProductNameBean>>();
  		cache.put(collectionId, productMap);
  	}
