...
public class SoarExtractItem extends SoarItem {
	...
	public SoarExtractItem(SoarExtractionDBService dbService, String eventId,
			String objectId, boolean icmDriver, String icmRule, String chronicleId, String collectionId,
			String itemId, String itemState, boolean isSuspended,
			boolean collectionAccepted, Date lastExtractionTime)
			throws DfException, ProcessingException, IOException {
		super(dbService, eventId, objectId, icmDriver, icmRule, chronicleId, collectionId, itemId,
				itemState, isSuspended, collectionAccepted, lastExtractionTime);
		...
		try {
			...
			if (results != null) {
				while (results.next()) {
					...
					// ICM changes
					return new SoarItem(dbService, eventId, objectId, icmDriver, icmRule, chronicleId, collectionId, itemId, OBSOLETE, false, collectionAccepted, null);
				}
			}
		} catch (DfException e) {
