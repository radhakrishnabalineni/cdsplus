 ...
 * @since       1.0
 */
public class SingleWIWorker implements Runnable {
	...
	// workItem queues
	SingleWIQueueManager queueManager;
	 ...
	 */
	public SingleWIWorker(SingleWIQueueManager queueManager, SingleSource source) {
...
//		this.historyHandler = historyHandler;
	 ...
	 */
	public void run() {
		SingleIWorkItem lastWorkItem = null;
			...
			try {
				...
				if (workItem.isValid()) {
					...
					if (!loaded || !workItem.isValid()) {
						...
						SingleIWorkItem prevWorkItem = workItem.getPrevItem();
