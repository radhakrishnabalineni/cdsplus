...
Dim URL
URL="http://cdsplus-itg.houston.hp.com/cadence/app/"
...
Function afterWithoutLimit(contentclass,subscription)
	Set ObjHTTP=CreateObject("MSXML2.serverxmlHTTP")
	ObjHTTP.open "GET","http://cdsplus-itg.houston.hp.com/cadence/app/"&contentclass&"/"&subscription&"/"
	ObjHTTP.send
	var =ObjHTTP.responseText
	...
	ObjHTTP.open "GET","http://cdsplus-itg.houston.hp.com/cadence/app/"&contentclass&"/"&subscription&"/*?after="&extractedLastModified
	ObjHTTP.send
	var =ObjHTTP.responseText
	'Msgbox  var
...
Function beforeWithoutLimit(contentclass,subscription)
	Set ObjHTTP=CreateObject("MSXML2.serverxmlHTTP")
	ObjHTTP.open "GET","http://cdsplus-itg.houston.hp.com/cadence/app/"&contentclass&"/"&subscription&"/*?reverse=true&limit=20"
	ObjHTTP.send
	var =ObjHTTP.responseText
	pos1=InstrRev(var,"lastModified",len(var))+len("lastModified")+2
	pos2=instr(pos1+2,var,chr(34))
	...
	ObjHTTP.open "GET","http://cdsplus-itg.houston.hp.com/cadence/app/"&contentclass&"/"&subscription&"/*?before="&extractedLastModified
	ObjHTTP.send
	var =ObjHTTP.responseText
	If  instr(1,var,"considered=")>0 then 
...
'Set objHTTP=CreateObject("msxml2.Serverxmlhttp")
'objHTTP.open "GET","http://cdsplus-itg.houston.hp.com/cadence/app/library/content/*?limit=100",false
'objHTTP.send
'var=objHTTP.ResponseText
