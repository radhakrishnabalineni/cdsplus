			...
			For m=2 To ws2.usedrange.rows.count
				For n=2 To ws2.usedrange.columns.count
					...
					If ws2.cells(m,n) <> "" Then
						...
						If worksheetName1 = "soar" Or worksheetName1 = "support" then
						var=""
							While var = ""
	   							objHttp.Open "GET", "http://cdsplus-itg.houston.hp.com/cadence/app/"&worksheetName1&"/"&ws2.cells(m,1)&"/"&ws2.cells(m,n), False 
  								objHttp.Send
						...
						End If
							...
							InValidDoc=InStr(var,"broken")
								...
								Else
										...
										Elseif	worksheetName1 = "support" Then
